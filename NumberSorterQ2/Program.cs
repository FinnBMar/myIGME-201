...
namespace NumberSort
{
    class Program
    {
        ...
        start:
            Console.WriteLine("Enter a space separated sentence of words.");
            ...
            while (aUnsorted.Length > 0)
            {
                ...
                aUnsorted[nSortedLength].CompareTo(aUnsorted[nSortedLength + 1]);

                // remove the current sorted value
                RemoveUnsortedValue(sNumbers[nSortedLength], ref aUnsorted);
