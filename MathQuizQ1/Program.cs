...
class Program
{
    ...
    start:
        ...
        do
        {
            ...
            {
                Console.WriteLine("Please enter a number. (round to 2 decimal places)");
                bValid = false;
            }
        ...
        for (nCntr = 0; nCntr < nQuestions; ++nCntr)
        {
            ...
            val1 = rand.Next(0, Convert.ToInt32(nMaxRange)) + nMaxRange;
            val2 = rand.Next(0, Convert.ToInt32(nMaxRange));
